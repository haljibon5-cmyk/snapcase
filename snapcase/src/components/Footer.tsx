      ...
      <div className="max-w-[1600px] mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16 text-center md:text-left">
          <div className="col-span-1">
            <Link to="/" className="inline-block mb-6 min-h-[40px]">
              {!isLoadingSettings &&
                (footerLogoImage ? (
                  <img
                    src={footerLogoImage}
                    alt={footerLogoText || "SnapCase"}
                    className="h-10 w-auto object-contain max-w-[200px]"
                  />
                ) : (
                  <span className="font-serif text-2xl tracking-wider text-black">
                    {footerLogoText || "SnapCase"}
                  </span>
                ))}
            </Link>
          ...
          <div className="md:flex md:flex-col md:items-center">
            <div className="text-center">
              <h3 className="text-sm font-semibold tracking-widest uppercase mb-6 text-black">
                Quick Links
              </h3>
